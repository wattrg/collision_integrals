...
def ci_comparison_n2():
    ...
    ax[0].plot(temps, gupta_yos_n2_11.eval(temps), label="Gupta Yos")
    ax[0].plot(temps, wright_et_al_n2_11.eval(temps), label="Wright et al")
    ax[0].plot(temps, laricchiuta_n2_n2_11.eval(temps), label="Laricchiuta")
    ax[0].set_ylabel("$\\Omega^{(1,1)}$, $\\AA^2$")
    ax[0].legend()
    ax[1].plot(temps, gupta_yos_n2_22.eval(temps), label="Gupta Yos")
    ax[1].plot(temps, wright_et_al_n2_22.eval(temps), label="Wright et al")
    ax[1].plot(temps, laricchiuta_n2_n2_22.eval(temps), label="Laricchiuta")
...
def ci_comparison_co2():
    ...
    ax_co2_n2[1].set_ylabel("$\\Omega^{2,2}_{CO_2, N_2}$")
